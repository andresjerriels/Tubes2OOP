...
public class Tile implements Serializable {
    ...
    public String getImgUrl() {
        if(type == TileType.Mountain) return "view/resources/tiles/mountain.png";
        else if(type == TileType.Sea) return "view/resources/tiles/sea.png";
        else if(type == TileType.Grassland) return "view/resources/tiles/grassland.png";
        else return "view/resources/tiles/tundra.png";
    }
